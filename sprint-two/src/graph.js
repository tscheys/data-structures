...
Graph.prototype.forEachNode = function(cb){
  // debugger;
  _.each(this, function(edgeArray, key) { // iteratee function(obj[key], key, obj)
    cb(key);
  });
};

/*
 * Complexity: What is the time complexity of the above functions? CONSTANT TIME LOOKUP
 */